...
export class TemaService {
  ...
  getByNomeTema(nome: string): Observable<Tema[]>{
    return this.http.get<Tema[]>(`https://blogpati.herokuapp.com/postagens/temas/${nome}`, this.token)
  }

  postTema(tema: Tema): Observable<Tema>{
    return this.http.post<Tema>('https://blogpati.herokuapp.com/temas',tema,this.token)
  }
